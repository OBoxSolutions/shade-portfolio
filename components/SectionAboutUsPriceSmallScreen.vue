<template>
  <div class="section-about-us-price">
    ...
    <div class="cube-under-price-wrapper">
...
.bottom {
  ...
  transform: rotateX(80deg) translateY(calc($height / 2 * -1));
}
